...
import { FaComments, FaComment, FaUserEdit, FaRegNewspaper, FaTrashAlt } from 'react-icons/fa';
            ...
            <Row>
                ...
                <Card bg="dark" text="light" className="mb-2">
                    ...
                    <Card.Body>
                        ...
                        {article.author === currentUser.email && <Button variant="outline-danger" size="sm"
